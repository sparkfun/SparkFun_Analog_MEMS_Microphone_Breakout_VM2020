...
<symbol name="VM2020">
<description>Vesper Technologies VM1010</description>
<pin name="OUT+" x="12.7" y="2.54" visible="pin" length="short" direction="out" rot="R180"/>
<pin name="GND" x="-10.16" y="-2.54" visible="pin" length="short" direction="pwr"/>
<pin name="OUT-" x="12.7" y="-2.54" visible="pin" length="short" direction="in" rot="R180"/>
...
<text x="-4.826" y="-7.62" size="1.778" layer="96">&gt;VALUE</text>
</symbol>
</symbols>
<devicesets>
<deviceset name="VM2020">
<description>Vesper Technologies VM2020
&lt;br&gt;&lt;br&gt;
The VM2020 is an ultra-high AOP, high dynamic range,
differential analog output piezoelectric MEMS microphone.
This microphone consists of a piezoelectric sensor and
circuitry to buffer and amplify the output.
It has an acoustic overload point of 152dB SPL for audio
capture in loud environments. The VM2020 has a small
3.76 mm X 2.95 mm X 1.3 mm package. This microphone
is reflow solder compatible with no sensitivity degradation.</description>
<gates>
<gate name="G$1" symbol="VM2020" x="0" y="0"/>
</gates>
<devices>
<device name="" package="VM2020">
<connects>
<connect gate="G$1" pin="GND" pad="2 3 4 5 8"/>
...
<technologies>
<technology name="">
<attribute name="DIGIKEY_PART" value="" constant="no"/>
<attribute name="MANU_PART" value="VM2020" constant="no"/>
...
<part name="U$1" library="vm2020" deviceset="VM2020" device=""/>
...
<sheet>
<plain>
<text x="238.76" y="7.62" size="2.54" layer="94" font="vector" ratio="9">v02</text>
...
<attribute name="DRAWING_NAME" x="162.814" y="17.78" size="1.6764" layer="94" font="vector"/>
...
<instance part="FD1" gate="G$1" x="241.3" y="43.18" smashed="yes"/>
...
<instance part="U$1" gate="G$1" x="104.14" y="119.38" smashed="yes">
<attribute name="NAME" x="99.314" y="125.222" size="1.778" layer="95"/>
<attribute name="VALUE" x="99.314" y="111.76" size="1.778" layer="96"/>
</instance>
